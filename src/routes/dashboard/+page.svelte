<script lang="ts">
    ...
    import Zeppelin from '@tabler/icons-svelte/icons/zeppelin';
...
>
    ...
    <tbody>
        {#each pastes as paste, i (paste.key)}
            <tr class="bg-gray-800" class:bg-gray-700={i % 2 === 1}>
...
>
    <p class="py-3 pl-4 text-gray-500 text-sm">
        ...
        perspiciatis tempora rerum?
    </p>
    <button class="px-4 bg-green-500 text-black hover:bg-green-600"
        >load more <IconArrowCapsule class="inline" size="16" /></button
    >
</form>
